...
Design::create_standard_models()
{
  ...
  pll_2f_core->add_port("DYNAMICDELAY[0]", Direction::IN);
  pll_2f_core->add_port("DYNAMICDELAY[1]", Direction::IN);
  pll_2f_core->add_port("DYNAMICDELAY[2]", Direction::IN);
  pll_2f_core->add_port("DYNAMICDELAY[3]", Direction::IN);
  pll_2f_core->add_port("DYNAMICDELAY[4]", Direction::IN);
  pll_2f_core->add_port("DYNAMICDELAY[5]", Direction::IN);
  pll_2f_core->add_port("DYNAMICDELAY[6]", Direction::IN);
  pll_2f_core->add_port("DYNAMICDELAY[7]", Direction::IN);
